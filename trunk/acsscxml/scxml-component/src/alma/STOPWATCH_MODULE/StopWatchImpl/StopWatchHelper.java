...
import alma.STOPWATCH_MODULE.StopWatchPOATie;
import alma.STOPWATCH_MODULE.StopWatchImpl.StopWatchImpl;
 ...
 * <p>
 * Name="STOPWATCH_1" Code="alma.STOPWATCH_MODULE.StopWatchImpl.StopWatchHelper" Type="IDL:alma/STOPWATCH_MODULE/StopWatch:1.0" Container="frodoContainer" ImplLang="java"
 * <p>
 * @author alma-component-helper-generator-tool
 */
public class StopWatchHelper extends ComponentHelper
{
	/**
	 * Constructor
	 * @param containerLogger logger used only by the parent class.
	 */
	public StopWatchHelper(Logger containerLogger)
	{
	...
	*/
	...
	{
		return StopWatchOperations.class;
	}
