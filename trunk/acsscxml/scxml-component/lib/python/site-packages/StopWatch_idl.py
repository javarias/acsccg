...
class _objref_StopWatch (_0_ACS._objref_ACSComponent):
    ...
    __methods__ = ["getDisplay", "getCurrentState", "fireEvent"] + _0_ACS._objref_ACSComponent.__methods__
...
class StopWatch (_0_ACS__POA.ACSComponent):
    ...
    _omni_op_d = {"getDisplay": _0_STOPWATCH_MODULE.StopWatch._d_getDisplay, "getCurrentState": _0_STOPWATCH_MODULE.StopWatch._d_getCurrentState, "fireEvent": _0_STOPWATCH_MODULE.StopWatch._d_fireEvent}
