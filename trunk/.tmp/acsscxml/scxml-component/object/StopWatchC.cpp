...
char * STOPWATCH_MODULE::StopWatch::getDisplay (
    void)
{
...
char * STOPWATCH_MODULE::StopWatch::getCurrentState (
    void)
{
  if (!this->is_evaluated ())
    {
...
::CORBA::Boolean STOPWATCH_MODULE::StopWatch::fireEvent (
    const char * event)
{
  if (!this->is_evaluated ())
    {
  ...
  TAO::Arg_Traits< ::CORBA::Char *>::in_arg_val _tao_event (event);
