...
/*PROTECTED REGION ID(AlcatelAntenna.ProtectedImports) ENABLED START*/
/* (non-javadoc!)
...
public class AlcatelAntennaBase extends BasicAntennaBase
		implements
			ComponentLifecycle,
			AlcatelAntennaBaseOperations {

	private ContainerServices m_containerServices;
	private Logger m_logger;

	/*PROTECTED REGION ID(AlcatelAntenna.ProtectedAttributes) ENABLED START*/
	/* (non-javadoc!)
	 * Autogenerated protected region, the imports in this protected area
	...
	/* 
	 * Definition of member AlcatelAntennaOperations
	 */

	public String getAlcatelID() {
		/*PROTECTED REGION ID(AlcatelAntenna.getAlcatelID) ENABLED START*/
		return new String();
		/*PROTECTED REGION END*/
	}
	...
	public void setAntennaPosition(position_struct position) {
		/*PROTECTED REGION ID(AlcatelAntenna.setAntennaPosition) ENABLED START*/
	...
	public position_struct getAntennaPosition() {
		/*PROTECTED REGION ID(AlcatelAntenna.getAntennaPosition) ENABLED START*/
	...
	/*PROTECTED REGION ID(AlcatelAntenna.ProtectedRegion) ENABLED START*/
	/* (non-javadoc!)
