...
public class StateChangeSemaphore
{
	 ...
	 */
	protected synchronized void stateChangedNotify(String oldStateHierarchy, String currentStateHierarchy) {
	    
        	logger.finest("stateChangedNotify: called in thread '" + Thread.currentThread().getName() + "'.");
       		logger.info("state machine switched from " + oldStateHierarchy + " to " + currentStateHierarchy);
	...
	public synchronized void reset() {
		//System.out.println("[SEMAFORO][reset()] ") ;
        	notifCount = 0;
	}
