 ...
 * who                 when                             what
 * ----------------    -----------------------------    ------------------------
 * ACSCCG              Tue Apr 19 00:13:29 CLT 2011    Creation of the file
 * 
 */
...
import alma.singleComponent.BasicAntennaInterfacePOATie;
 ...
 * @version $Id$
 */
public class BasicAntennaJavaImplHelper extends ComponentHelper
{
	 ...
	 */
	public BasicAntennaJavaImplHelper(Logger containerLogger)
	{
	...
	{
		return new BasicAntennaJavaImpl();
	}
	...
	{
		return BasicAntennaInterfacePOATie.class;
	}
	...
	{
		return BasicAntennaInterfaceOperations.class;
	}
